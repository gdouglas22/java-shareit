...
public class BookingController {
    ...
    public ResponseEntity<Object> approve(@RequestHeader(HeaderConstants.USER_ID) Long ownerId,
    ...
    @GetMapping
    public ResponseEntity<Object> getBookings(@RequestHeader(HeaderConstants.USER_ID) Long userId,
                                              @RequestParam(name = "state", defaultValue = "ALL") String state) {
        return bookingClient.getBookings(userId, state);
    }

    @GetMapping("/owner")
    public ResponseEntity<Object> getOwnerBookings(@RequestHeader(HeaderConstants.USER_ID) Long ownerId,
                                                   @RequestParam(name = "state", defaultValue = "ALL") String state) {
